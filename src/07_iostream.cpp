...
int main() {
  ...
  // 1. Что есть в этой библиотеке?
  // > различные функции и объекты для работы с вводом и выводом данных

  // 2. Вывод данных в стандартный поток вывода stdout.
  ...
  // 3. Ввод данных из стандартного потока ввода stdin.

  std::cout << "Enter: \n";  // выводим пользователю сообщение о том, что надо будет ввести данные
...
/*
 * Задания:
 * 1. Допишите код с вводом данных пользователя (3) так, чтобы введенное число выводилось на экран.
